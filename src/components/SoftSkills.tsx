...
import { softSkillIcons, FlagBRIcon, FlagESIcon, FlagGBIcon } from "./Icons";

const langFlagMap: Record<string, React.ReactNode> = {
  pt: <FlagBRIcon size={24} />,
  es: <FlagESIcon size={24} />,
  en: <FlagGBIcon size={24} />,
};
              ...
              {t.softSkills.skills.map((skill, index) => (
                ...
                >
                  <div className="flex-shrink-0 text-foreground/60">
                    {(() => { const Icon = softSkillIcons[index]; return Icon ? <Icon size={22} /> : null; })()}
                  </div>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="flex-shrink-0">
                        {langFlagMap[lang.code] ?? <FlagBRIcon size={24} />}
                      </div>
